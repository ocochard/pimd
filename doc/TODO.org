...
The list itself is done: sections 4.2 to 4.6 and 4.10/4.11 were read against
the code and what disagrees is written up there, with a file:line and an
effort estimate per entry.  Three of them are input validation or trust
issues and are listed first.  Still unread: 4.7 (BSR, and RFC 5059), 4.8
(SSM), 4.9 as a whole, and the security considerations.
